...
public class Orders {
	...
	public static Orders fromJsonToOrders(String json) {
        return new JSONDeserializer<Orders>()
        .use(null, Orders.class).deserialize(json);
    }
	...
	public static Collection<Orders> fromJsonArrayToOrderses(String json) {
        return new JSONDeserializer<List<Orders>>()
        .use("values", Orders.class).deserialize(json);
    }
